    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex justify-center gap-2">
          ...
          <Link
            to="/products"
            className="inline-flex items-center justify-center rounded-xl border border-input px-4 py-2 text-sm font-semibold text-foreground"
          >
            Shop supplements
          </Link>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "OM Nutrition Panipat — Genuine Supplement Store" },
      { name: "description", content: site.description },
      { name: "author", content: site.owner },
      { property: "og:site_name", content: "OM Nutrition Panipat" },
